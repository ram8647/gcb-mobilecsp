...
def notify_module_enabled():
    ...
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teacher_dashboard/resources/js/tipped.js')
    ...
    dashboard.DashboardHandler.EXTRA_CSS_HREF_LIST.append('/modules/teacher_dashboard/resources/css/tipped.css')

...
RESOURCES_PATH = '/modules/teachers/resources'

TEMPLATES_DIR = os.path.join(
    appengine_config.BUNDLE_ROOT, 'modules', 'teachers', 'templates')
...
ACCESS_TEACHER_DASHBOARD_PERMISSION = 'can_access_teachers'
...
#class TeacherDashboardHandler(dashboard.DashboardHandler):
class TeacherDashboardHandler(utils.BaseHandler):
...
def notify_module_enabled():
    ...
    def get_action(handler):
        """Redirects to teachers."""
        handler.redirect('/modules/teachers?action=teachers&tab=%s' % handler.request.get('tab') or
                         TeacherDashboardHandler.DEFAULT_TAB)
    def post_action(handler):
        TeacherDashboardHandler.post_teacher_reg(handler)

    dashboard.DashboardHandler.add_nav_mapping(TeacherDashboardHandler.ACTION, 'Teachers')
#    dashboard.DashboardHandler.add_sub_nav_mapping(TeacherDashboardHandler.ACTION, 'teachers', 'Teachers', href='dashboard?action=teachers&tab=')

    dashboard.DashboardHandler.add_sub_nav_mapping(TeacherDashboardHandler.ACTION, 'help', 'Documentation', 
           href='https://docs.google.com/document/d/1XKGfVl_tQDGF0JPQFKh-PKiVKkn5Qu3LOZEJEzpjoaY', target='_blank')
    dashboard.DashboardHandler.add_sub_nav_mapping(TeacherDashboardHandler.ACTION, 'sections', 'Sections', href='dashboard?action=teachers&tab=')
    dashboard.DashboardHandler.add_sub_nav_mapping(TeacherDashboardHandler.ACTION, 'student_detail', 'Students', href='dashboard?action=teachers&tab=student_detail' )
    dashboard.DashboardHandler.add_sub_nav_mapping(TeacherDashboardHandler.ACTION, 'teacher_reg', 'Teachers', href='dashboard?action=teachers&tab=teacher_reg')

    dashboard.DashboardHandler.get_actions.append('teachers')
    setattr(dashboard.DashboardHandler, 'get_teachers', get_action)
    ...
    TeacherDashboardHandler.add_external_permission(
    ...
    dashboard.DashboardHandler.map_get_action_to_permission(str(TeacherDashboardHandler.ACTION), custom_module, ACCESS_TEACHER_DASHBOARD_PERMISSION)

    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/popup.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/course_section_analytics.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/activity_score_manager.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/student_list_table_manager.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/student_list_table_rebuild_manager.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/activity_score_table_manager.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/student_score_manager.js')
    dashboard.DashboardHandler.EXTRA_JS_HREF_LIST.append('/modules/teachers/resources/js/tipped.js')

    dashboard.DashboardHandler.EXTRA_CSS_HREF_LIST.append('/modules/teachers/resources/css/student_list.css')
    dashboard.DashboardHandler.EXTRA_CSS_HREF_LIST.append('/modules/teachers/resources/css/student_progress.css')
    dashboard.DashboardHandler.EXTRA_CSS_HREF_LIST.append('/modules/teachers/resources/css/view.css')
    dashboard.DashboardHandler.EXTRA_CSS_HREF_LIST.append('/modules/teachers/resources/css/tipped.css')
...
def register_module():
    ...
    namespaced_routes = [
         (TeacherDashboardHandler.URL, TeacherDashboardHandler),
    ...
    dashboard_handlers = [
        ('/post_teacher_reg', TeacherDashboardHandler),
    ]

#     def notify_module_enabled():
#         dashboard.DashboardHandler.add_sub_nav_mapping(
#             'publish', 'teachers', 'Teachers', placement=2000)

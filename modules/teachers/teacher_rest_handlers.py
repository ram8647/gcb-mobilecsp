...
class ActivityScoreRestHandler(BaseRESTHandler):
    ...
    URL = '/rest/modules/teachers/activity_scores'
    ...
    def get(self):
        ...
        for student in students:
            if '@' in student:
                temp_students.append(Teacher.get_student_by_email(student).user_id)
...
class StudentProgressRestHandler(BaseRESTHandler):
    ...
    URL = '/rest/modules/teachers/student_progress'
    ...
    def get(self):
        ...
        student = Teacher.get_student_by_email(key.strip())
...
class CourseSectionRestHandler(BaseRESTHandler):
    ...
    URL = '/rest/modules/teachers/section'
...
#                         student[
#                         'email']), self.get_course())
                    student['detailed_course_completion'] = teacher_parsers.StudentProgressTracker.get_detailed_progress(
                        this_student, self.get_course())
